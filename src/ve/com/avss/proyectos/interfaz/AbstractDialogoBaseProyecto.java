...
public abstract class AbstractDialogoBaseProyecto extends JDialog {
	...
	//recurso
	protected JLabel eRecursoTarea = new JLabel();
	protected JComboBox comboRecursoTarea = new JComboBox();
	//observacion
...
//datos paraactualizar
	...
	protected JComboBox comboRecursoTareaAct = new JComboBox();
	...
	public AbstractDialogoBaseProyecto(JFrame parent) {
		super(parent, true);
		...
		comboRecursoTareaAct.addItem("");
		comboStatusTarea.addItem("");
		comboRecursoTarea.addItem("");
		...
		for (int i = 0; i < listaRecursos.size(); i++) {
			...
			comboRecursoTareaAct.addItem(listaRecursos.get(i).getNombre()+" "+listaRecursos.get(i).getApellido());
	...
	protected void armarCampos(String campo) {
		...
		case "statusTarea":
			...
			break;
		case "recursoTarea":
			comboRecursoTarea.setName("tipoCP");
			comboRecursoTarea.setBackground(Color.WHITE);
			comboRecursoTarea.setPreferredSize(new Dimension(100, 28));
			((JComboBox) comboStatus).addItem("");
			for (int i = 0; i < listaRecursos.size(); i++) {
				((JComboBox) comboRecursoTarea).addItem(listaRecursos.get(i).getNombre()+" "+listaRecursos.get(i).getApellido());
			}
			break;
		case "guardarCita":
	...
	protected void armarEtiquetas(String campo) {
		...
		case "observacionProx":
			...
			break;
		case "observacion":
			eObservacion.setPreferredSize(new java.awt.Dimension(200, 15));
		...
		case "descripcionTarea":
			...
			break;
		case "fechaDesarrollo":
			eFechaDesarrollo.setPreferredSize(new java.awt.Dimension(200, 15));
		...
		case "statusTarea":
			...
			break;
		case "recursoTarea":
			eRecursoTarea.setPreferredSize(new java.awt.Dimension(70, 15));
			eRecursoTarea.setText("Recurso");
			break;
		case "tablaProductos":
